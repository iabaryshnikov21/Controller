...
#include "../new_micro/customscene.h"
...
QT_MOC_LITERAL(4, 42, 21), // "signalPressLeftButton"
QT_MOC_LITERAL(5, 64, 23), // "signalUnPressLeftButton"
QT_MOC_LITERAL(6, 88, 14) // "signalMoveLine"

    },
    "CustomScene\0signalTargetCoordinate\0\0"
    "point\0signalPressLeftButton\0"
    "signalUnPressLeftButton\0signalMoveLine"
};
...
void CustomScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->signalPressLeftButton((*reinterpret_cast< QPointF(*)>(_a[1]))); break;
        case 2: _t->signalUnPressLeftButton((*reinterpret_cast< QPointF(*)>(_a[1]))); break;
        case 3: _t->signalMoveLine((*reinterpret_cast< QPointF(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CustomScene::signalTargetCoordinate)) {
                *result = 0;
            }
        }
        {
            typedef void (CustomScene::*_t)(QPointF );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CustomScene::signalPressLeftButton)) {
                *result = 1;
            }
        }
        {
            typedef void (CustomScene::*_t)(QPointF );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CustomScene::signalUnPressLeftButton)) {
                *result = 2;
            }
        }
        {
            typedef void (CustomScene::*_t)(QPointF );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CustomScene::signalMoveLine)) {
                *result = 3;
            }
        }
    }
...
// SIGNAL 1
void CustomScene::signalPressLeftButton(QPointF _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void CustomScene::signalUnPressLeftButton(QPointF _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 3
void CustomScene::signalMoveLine(QPointF _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
